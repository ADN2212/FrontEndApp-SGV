			...
			{ /* Mostrar la forma solo si no hay viajes filtrados, es decir, si no se ha calculado nada */
				...
				<div className="container-fluid">
					<div className = 'row'>
						...
						<div className = 'col m-3 bg-dark AnchoForma p-3 border border-primary border-3 rounded-5 text-white '>
							<form onSubmit = { (evento) => { todosLosViajes(evento) } }>				
									<h6 className = 'display-6 text-primary'> Haga click aqui si desea ver las ganancias globales </h6>
									<br></br>
									<input type='submit' className = 'btn btn-success m-2' value = 'Calcular Ganancias Globales' />
							</form>
						</div>
