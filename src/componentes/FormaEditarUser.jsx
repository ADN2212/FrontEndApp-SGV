...
export default function FormarEditarUser({
	actualUser,
	arrayUsuarios,
	putFunc,
	cambiarEstado,
		...
		<form
			...
			<label className='form-label'>
				...
				<input
					...
					onChange={(evento) => {
						alCambiar(evento, toEditUser, settoEditUser);
					}}
					required
				/>
			</label>
			...
			<br></br>
			<input type='submit' value='Editar Usuario' className='btn btn-success' />
		</form>
	);
}