...
export default function FormaChofer({arrayChoferes, postFunc, putFunc, jsonTipoChofer}) {
	...
	return (
		...
		<form onSubmit = {EnvirarData}>
			...
			<label>
			Clasificación:
				<select name = 'clasificacion' value = {data.clasificacion || ""} onChange = { (evento) => {alCambiar(evento, data, setData)} }>
